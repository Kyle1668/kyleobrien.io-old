...
class About extends React.Component {
    ...
    constructor() {
        ...
        this.state = {
            paragraphs: [
                {
                    paragraph: "Hello! My name is Kyle, and I’m a Junior at University of California, Santa Cruz" +
                    ...
                    paragraph: "Through my various internships and side projects, I've experienced working acros" +
                    ...
                    paragraph: "Outside of academics, I'm an avid endurance athlete, foodie, and amateur histori" +
                            "an! I love spending time in nature with friends and conversations over beer and " +
                            "coffee.",
                    ordering: 3
                }, {
                    paragraph: "I am currently on the search for summer internship opportunities in the fields o" +
    ...
    renderParagraphs() {
        return this
            ...
            .map((data, key) => {
                if (key + 1 <= 5) {
                    return <div className="paragraph" key={key}>
                        <p>{data.paragraph}</p>
                    </div>
                }
            })
